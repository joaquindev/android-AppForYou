...
/**
 * Generic content provider, which makes any files available in this app's "assets"
 * directory available publicly.
 *
 * <p>To use, add the following to your AndroidManifest.xml</p>
 * <code><pre>
 *     <provider
 *      android:name=".AssetProvider"
 *      android:authorities="[Your Content Provider Domain Here]"
 *      android:grantUriPersmissions="true"
 *      android:expoted="true"/>
 *     </provider>
 * </pre></code>
 */
...
public class AssetProvider extends ContentProvider {
     ...
     * @link AssetProvider
     */
    public static String CONTENT_URI = "com.replicaappforyou.app";
